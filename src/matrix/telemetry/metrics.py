...
def log_signal_behavior_metrics(
    long_trigger_rate: float,
    short_trigger_rate: float,
    avg_holding_period: float,
    signal_oscillations: int,
    threshold_effectiveness: float,
    neutral_time_pct: float,
) -> None:
    """
...
def export_metrics_json(
    backtest_id: str, output_path: Optional[str] = None
) -> Dict[str, Any]:
    """
