...
def main():
    ...
    cmd = [sys.executable, "scripts/training/evaluate_wfo.py",
           "--dataset", str(dataset),
    ...
    with open(out_md) as f:
        header = f.readline()
    expected_cols = ["train_from","train_to","test_from","test_to","n","nan_ratio","trigger_rate","mean_R","hit_rate","dd_min"]
